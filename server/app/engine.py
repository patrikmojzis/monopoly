...
BOARD: tuple[Space, ...] = (
    ...
    Space(1, "Prompt Alley", "property", 60, 2, "brown", 50, (2, 10, 30, 90, 160, 250)),
    Space(2, "Community Cache", "chest"),
    Space(3, "Token Street", "property", 60, 4, "brown", 50, (4, 20, 60, 180, 320, 450)),
    Space(4, "Cloud Tax", "tax", rent=200),
    Space(5, "GPU Express", "railroad", 200, 25, "railroad"),
    Space(6, "Vector Lane", "property", 100, 6, "light-blue", 50, (6, 30, 90, 270, 400, 550)),
    Space(7, "Chance: Incident Card", "chance"),
    Space(8, "Webhook Wharf", "property", 100, 6, "light-blue", 50, (6, 30, 90, 270, 400, 550)),
    Space(9, "SQLite Square", "property", 120, 8, "light-blue", 50, (8, 40, 100, 300, 450, 600)),
    Space(10, "Jail / Just Visiting", "jail"),
    Space(11, "Docker Drive", "property", 140, 10, "pink", 100, (10, 50, 150, 450, 625, 750)),
    Space(12, "Electric LLM Utility", "utility", 150, 0, "utility"),
    Space(13, "Telepathy Terrace", "property", 140, 10, "pink", 100, (10, 50, 150, 450, 625, 750)),
    Space(14, "Calendar Court", "property", 160, 12, "pink", 100, (12, 60, 180, 500, 700, 900)),
    Space(15, "Cron Rail", "railroad", 200, 25, "railroad"),
    Space(16, "Bugfix Boulevard", "property", 180, 14, "orange", 100, (14, 70, 200, 550, 750, 950)),
    Space(17, "Community Cache", "chest"),
    Space(18, "Agent Avenue", "property", 180, 14, "orange", 100, (14, 70, 200, 550, 750, 950)),
    Space(19, "Panda HQ", "property", 200, 16, "orange", 100, (16, 80, 220, 600, 800, 1000)),
    Space(20, "Free Parking / Couch Break", "free_parking"),
    Space(21, "Serverless Strip", "property", 220, 18, "red", 150, (18, 90, 250, 700, 875, 1050)),
    Space(22, "Chance: Product Pivot", "chance"),
    Space(23, "FastAPI Falls", "property", 220, 18, "red", 150, (18, 90, 250, 700, 875, 1050)),
    Space(24, "React Ridge", "property", 240, 20, "red", 150, (20, 100, 300, 750, 925, 1100)),
    Space(25, "Nginx Northern Line", "railroad", 200, 25, "railroad"),
    Space(26, "Stripe Street", "property", 260, 22, "yellow", 150, (22, 110, 330, 800, 975, 1150)),
    Space(27, "TidyCal Towers", "property", 260, 22, "yellow", 150, (22, 110, 330, 800, 975, 1150)),
    Space(28, "Waterfall API Utility", "utility", 150, 0, "utility"),
    Space(29, "Rozsudky Row", "property", 280, 24, "yellow", 150, (24, 120, 360, 850, 1025, 1200)),
    Space(30, "Go To Jail / Rate Limited", "go_to_jail"),
    Space(31, "Luna Labs", "property", 300, 26, "green", 200, (26, 130, 390, 900, 1100, 1275)),
    Space(32, "Angelina Avenue", "property", 300, 26, "green", 200, (26, 130, 390, 900, 1100, 1275)),
    Space(33, "Community Cache", "chest"),
    Space(34, "Vienna Loop", "property", 320, 28, "green", 200, (28, 150, 450, 1000, 1200, 1400)),
    Space(35, "GitHub Actions Rail", "railroad", 200, 25, "railroad"),
    Space(36, "Chance: Demo Gods", "chance"),
    Space(37, "Ortoart Orbit", "property", 350, 35, "dark-blue", 200, (35, 175, 500, 1100, 1300, 1500)),
    Space(38, "Luxury Cloud Bill", "tax", rent=100),
